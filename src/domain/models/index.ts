/**
 * DOMAIN LAYER - Models
 * Core business entities and value objects for the FOMAG Concurrent Hospital Audit System.
 */
export * from './concurrentAudit';
export * from './knowledgeLibrary';
export * from './PatientClinicalContext';
export * from './ClinicalProblemMap';
export * from './ClinicalAuditRiskMap';
export * from './IPSContext';
export * from './ContextualFinding';
export * from './AuditSession';
export * from './AuditReport';
export * from './DashboardFilter';
export * from './DashboardMetrics';
export * from './DashboardSnapshot';
export * from './IPSComparison';
...
export type Document = ClinicalDocHC;

/**
 * Domain Evidence Entity
 */
...
export interface AuditRule {
  ...
  legalNormative?: string;
}

/**
 * Domain Audit Result & Risk Entities
 */
export interface AuditRiskAssessment {
  score: number;
  level: ProlongedStayRisk;
  prolongedStayRisk: boolean;
...
/**
 * Expedient (Audit) Aggregate Root Entity
 */
